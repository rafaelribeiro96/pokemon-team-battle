  ...
  heroSlides = [
    {
      ...
      featuredPokemon: [
        ...
        {
          name: 'Arcanine',
          image: '/assets/images/pokemon-arcanine.png',
        },
        {
          name: 'Blaziken',
          image: '/assets/images/pokemon-blaziken.png',
        },
      ],
    },
    {
      ...
      pokemonSilhouette: '/assets/images/pokemon-blastoise-silhouette.png',
      featuredPokemon: [
        {
          name: 'Blastoise',
          image: '/assets/images/pokemon-blastoise.png',
        },
        {
          name: 'Gyarados',
          image: '/assets/images/pokemon-gyarados.png',
        },
        {
          name: 'Vaporeon',
          image: '/assets/images/pokemon-vaporeon.png',
        },
      ],
    },
    {
      ...
      featuredPokemon: [
        ...
        {
          name: 'Raichu',
          image: '/assets/images/pokemon-raichu.png',
        },
        {
          name: 'Electabuzz',
          image: '/assets/images/pokemon-electabuzz.png',
        },
      ],
    },
    {
      ...
      badge: 'Explorar',
      image: '/assets/images/hero-grass.jpg',
      ...
      pokemonSilhouette: '/assets/images/pokemon-venusaur-silhouette.png',
      featuredPokemon: [
        {
          name: 'Venusaur',
          image: '/assets/images/pokemon-venusaur.png',
        },
        {
          name: 'Sceptile',
          image: '/assets/images/pokemon-sceptile.png',
        },
        {
          name: 'Bulbasaur',
          image: '/assets/images/pokemon-bulbasaur.png',
        },
      ],
    },
    {
      ...
      badge: 'Especial',
      image: '/assets/images/hero-psychic.jpg',
      ...
      pokemonSilhouette: '/assets/images/pokemon-mewtwo-silhouette.png',
      featuredPokemon: [
        {
          name: 'Mewtwo',
        ...
        {
          name: 'Alakazam',
          image: '/assets/images/pokemon-alakazam.png',
        },
        {
          name: 'Espeon',
          image: '/assets/images/pokemon-espeon.png',
        },
      ],
    },
  ];
